...
public class RemoveNthLastNode {
    ...
    public static RemoveNthLastNode.LinkedListNode removeNthLastNode(RemoveNthLastNode.LinkedListNode head, int n) {
        // Create a dummy node to handle edge cases (e.g., removing head)
        RemoveNthLastNode.LinkedListNode dummy = new RemoveNthLastNode.LinkedListNode(0);
        dummy.next = head;

        RemoveNthLastNode.LinkedListNode slow = dummy;
        RemoveNthLastNode.LinkedListNode fast = head;
    ...
    public static void main(String[] args) {
        ...
        RemoveNthLastNode.LinkedListNode head1 = buildLinkedList(new int[]{1,2,3,4,5});
        head1 = removeNthLastNode(head1, 2);
        System.out.println("After removing 2nd last from [1,2,3,4,5]: " + linkedListToString(head1));

        // Test Case 2: [1], n=1 => []
        RemoveNthLastNode.LinkedListNode head2 = buildLinkedList(new int[]{1});
        ...
        RemoveNthLastNode.LinkedListNode head3 = buildLinkedList(new int[]{1,2});
        ...
        // Input: [1,2,3], n=3 => [2,3]
        RemoveNthLastNode.LinkedListNode head4 = buildLinkedList(new int[]{1,2,3});
        head4 = removeNthLastNode(head4, 3);
        System.out.println("After removing 3rd last from [1,2,3]: " + linkedListToString(head4));
    }

    private static RemoveNthLastNode.LinkedListNode buildLinkedList(int[] values) {
        RemoveNthLastNode.LinkedListNode dummy = new RemoveNthLastNode.LinkedListNode(0);
        RemoveNthLastNode.LinkedListNode current = dummy;
        for (int val : values) {
            current.next = new RemoveNthLastNode.LinkedListNode(val);
            current = current.next;
        }
        return dummy.next;
    }

    private static String linkedListToString(RemoveNthLastNode.LinkedListNode head) {
    ...
    public static class LinkedListNode {
        int val;
        RemoveNthLastNode.LinkedListNode next;
